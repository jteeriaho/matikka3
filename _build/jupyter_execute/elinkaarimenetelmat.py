...
# 
# > **Johtopäätökset**:         
# > Kohdassa a) nettonykyarvo on 80 000 € negatiivinen => 15% tuottotavoite jää saavuttamatta ja jos sitä pidetään kannattavuusrajana, investointi **ei ole kannattava**     
# 
# > Kohdassa b) viivan alla jäävä 20 vuoden nettotuotto on nykyrahassa 850 000 €. Sen verran jää investoinnista käteen lainojen hoidon + riskivarausten 4.5 prosentin osuuden jälkeen). Ristiriitaa ei kuitenkaan ole a) -kohdan tuloksen kanssa, koska viivan alle jäävä summa ei anna 16 prosentin tuottoa.       
# 
