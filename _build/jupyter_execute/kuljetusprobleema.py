...
# :class: tip     
# Kuljetusyritys toimittaa soraa tierakennuskohteisiin. Sillä on kolme soravarastoa  V1, V2 ja V3 joissa on soraa 1500 $m^3$, 3000 $m^3$ ja 2000 $m^3$.   Toimituskohteita on myös kolme:   K1, K2 ja K3, joihin toimitettavat määrät ovat 1000 $m^3$, 1700 $m^3$ ja 2100 $m^3$.   Alla olevassa taulukossa on ruutuihin kirjoitettu etäisyydet soravarastojen ja kohteiden välillä.    Määritä kustakin soravarastosta kuhunkin kohteeseen toimitettavat määrät siten, että kuljetusten kokonaiskilometrimäärä on mahdollisimman pieni.
