...
# 1.63 &\text{(x-e^x-x-3)/(e^x-1) where x=2}  & 1.51 \\
# 1.51 &\text{(x-e^x-x-3)/(e^x-1) where x=2}  & 1.51
# \end{matrix}$
# 
# 
...
# -3 &\text{(x-e^x-x-3)/(e^x-1) where x=2}  & -2.95 \\
# -2.95 &\text{(x-e^x-x-3)/(e^x-1) where x=2}  & -2.95
# \end{matrix}$
# ```
# ````
